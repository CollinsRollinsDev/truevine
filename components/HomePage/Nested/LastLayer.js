      ...
      <section data-aos="zoom-in" className={styles.container}>
        <div className={styles.subContainer}>
          <div className={styles.first}>
            ...
            <div className={styles.firstText}>HeadQuater Location (Benin)</div>
          </div>
          <div className={styles.second}>
            <div className={styles.second}>
              <p>Truevine Christian Centre, Truevine Close,</p>
              <p>Evbouvbuke Community,</p>
              <p>Ekenwan Barracks,</p>
              <p>Benin City. Nigeria, West Africa.</p>
            </div>
          </div>
        ...
        <div className={styles.subContainer}>
          <div className={styles.first}>
            ...
            <div className={styles.firstText}>Lagos Branch Location</div>
          </div>
          <div className={styles.second}>
            <div className={styles.second}>
              <p>14, Anjorin Close,</p>
              <p>off Abusatu Street,</p>
              <p>Adealu Bus stop, Lagos,</p>
